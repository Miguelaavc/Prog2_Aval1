class Genotype {
  ...
  bool compatible(Genotype genotypex) {
    bool status = false;
    if (_genotype == "ii" ||
    genotypex._genotype == "AB" ||
    _genotype == genotypex._genotype) {
      return true;
    } else if (_genotype == "AB" && genotypex._genotype != "AB") {
      return false;
    } else if (genotypex.agglutinogens.contains(agglutinogens[0])) {
      return true;
    }
    return status;
  }
